...
QT_TRANSLATE_NOOP("midas-core", ""
"Cannot obtain a lock on data directory %s. Midas is probably already "
"running."),
QT_TRANSLATE_NOOP("midas-core", ""
...
QT_TRANSLATE_NOOP("midas-core", ""
"Disable all Midas specific functionality (Masternodes, Obfuscation, SwiftTX, "
...
QT_TRANSLATE_NOOP("midas-core", ""
"To use midasd, or the -server option to midas-qt, you must set an rpcpassword "
...
QT_TRANSLATE_NOOP("midas-core", ""
"Unable to bind to %s on this computer. Midas is probably already running."),
QT_TRANSLATE_NOOP("midas-core", ""
...
"your clock is wrong Midas will not work properly."),
QT_TRANSLATE_NOOP("midas-core", ""
...
QT_TRANSLATE_NOOP("midas-core", "(22331 could be used only on mainnet)"),
QT_TRANSLATE_NOOP("midas-core", "(default: %s)"),
QT_TRANSLATE_NOOP("midas-core", "(default: 1)"),
QT_TRANSLATE_NOOP("midas-core", "(must be 22331 for mainnet)"),
...
QT_TRANSLATE_NOOP("midas-core", "Acceptable ciphers (default: %s)"),
...
QT_TRANSLATE_NOOP("midas-core", "Copyright (C) 2015-%i The PIVX Core Developers"),
QT_TRANSLATE_NOOP("midas-core", "Copyright (C) %i The Midas Developers"),
QT_TRANSLATE_NOOP("midas-core", "Corrupted block database detected"),
QT_TRANSLATE_NOOP("midas-core", "Could not parse -rpcbind value %s as network address"),
...
QT_TRANSLATE_NOOP("midas-core", "Enable publish hash transaction (locked via SwiftTX) in <address>"),
...
QT_TRANSLATE_NOOP("midas-core", "Enable publish raw transaction (locked via SwiftTX) in <address>"),
...
QT_TRANSLATE_NOOP("midas-core", "Error loading wallet.dat: Wallet requires newer version of Midas"),
...
QT_TRANSLATE_NOOP("midas-core", "Initialization sanity check failed. Midas is shutting down."),
QT_TRANSLATE_NOOP("midas-core", "Input is not valid."),
QT_TRANSLATE_NOOP("midas-core", "Insufficient funds."),
QT_TRANSLATE_NOOP("midas-core", "Invalid -onion address: '%s'"),
QT_TRANSLATE_NOOP("midas-core", "Invalid -proxy address: '%s'"),
...
QT_TRANSLATE_NOOP("midas-core", "Keep N Midas anonymized (default: %u)"),
...
QT_TRANSLATE_NOOP("midas-core", "Obfuscation options:"),
...
QT_TRANSLATE_NOOP("midas-core", "RPC SSL options: (see the Bitcoin Wiki for SSL setup instructions)"),
QT_TRANSLATE_NOOP("midas-core", "RPC server options:"),
QT_TRANSLATE_NOOP("midas-core", "RPC support for HTTP persistent connections (default: %d)"),
...
QT_TRANSLATE_NOOP("midas-core", "Server certificate file (default: %s)"),
QT_TRANSLATE_NOOP("midas-core", "Server private key (default: %s)"),
...
QT_TRANSLATE_NOOP("midas-core", "SwiftTX options:"),
...
QT_TRANSLATE_NOOP("midas-core", "Use N separate masternodes to anonymize funds  (2-8, default: %u)"),
QT_TRANSLATE_NOOP("midas-core", "Use OpenSSL (https) for JSON-RPC connections"),
...
QT_TRANSLATE_NOOP("midas-core", "Wallet needed to be rewritten: restart Midas to complete"),
