...
The Midas project operates an open contributor model where anyone is
...
The following applies to code changes to the Midas project, and is not to be
confused with overall Midas Network Protocol consensus changes.

Whether a pull request is merged into Midas rests with the project merge
...
The project leader is the release manager for each Midas release.
