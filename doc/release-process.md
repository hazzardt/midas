...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/hazzardt/midas/blob/master/doc/translation_process.md#synchronising-translations).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/hazzardt/gitian.sigs.git
    git clone https://github.com/hazzardt/midas-detached-sigs.git
    git clone https://github.com/devrandom/gitian-builder.git
    git clone https://github.com/hazzardt/midas.git
...
### Build and sign Midas for Linux, Windows, and OS X:
...
space *do not upload these to the midas.io server*.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/hazzardt/midas/releases/new) with a link to the archived release notes.
